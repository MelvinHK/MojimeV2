  ...
  return (
    <Menu.Root>
      <Menu.Button className="media-button">
        {roundedValue > 5 ?
          <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" className="bi bi-volume-up-fill" viewBox="3 3.5 9.3 9.3">
            <path d="M10.121 12.596A6.48 6.48 0 0 0 12.025 8a6.48 6.48 0 0 0-1.904-4.596l-.707.707A5.48 5.48 0 0 1 11.025 8a5.48 5.48 0 0 1-1.61 3.89z" />
            <path d="M8.707 11.182A4.5 4.5 0 0 0 10.025 8a4.5 4.5 0 0 0-1.318-3.182L8 5.525A3.5 3.5 0 0 1 9.025 8 3.5 3.5 0 0 1 8 10.475zM6.717 3.55A.5.5 0 0 1 7 4v8a.5.5 0 0 1-.812.39L3.825 10.5H1.5A.5.5 0 0 1 1 10V6a.5.5 0 0 1 .5-.5h2.325l2.363-1.89a.5.5 0 0 1 .529-.06" />
          </svg>
        : value > 0 ?
          <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" className="bi bi-volume-down-fill" viewBox="5 3.5 9.3 9.3">
        ...
        :
          <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" className="bi bi-volume-mute-fill" viewBox="3 3.5 9.3 9.3">
